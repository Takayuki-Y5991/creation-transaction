...
var G__13163 = (i__5727__auto___13162 + (1));
i__5727__auto___13162 = G__13163;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq13052){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13053,G__13054,seq13052__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__13102_SHARP_){
return (!((cljs.core.meta(p1__13102_SHARP_) == null)));
})))){
...
var map__13121 = opts;
var map__13121__$1 = cljs.core.__destructure_map(map__13121);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13121__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e13122){var _e__12006__auto__ = e13122;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e13129){var _e__12006__auto__ = e13129;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__13136 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__13137 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__13137);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13138__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__13136);
}});
...
var temp__5802__auto___13181 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13181)){
var managed_print_level_13182 = temp__5802__auto___13181;
var _STAR_print_level_STAR__orig_val__13150_13183 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13151_13184 = managed_print_level_13182;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13151_13184);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__13144_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__13144_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13150_13183);
}} else {
job_fn();
}
