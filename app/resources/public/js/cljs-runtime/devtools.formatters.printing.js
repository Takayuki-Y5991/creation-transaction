...
var len__5726__auto___18046 = arguments.length;
var i__5727__auto___18047 = (0);
while(true){
if((i__5727__auto___18047 < len__5726__auto___18046)){
args__5732__auto__.push((arguments[i__5727__auto___18047]));

var G__18048 = (i__5727__auto___18047 + (1));
i__5727__auto___18047 = G__18048;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq17950){
...
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__17951,G__17952,seq17950__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__17975_SHARP_){
return (!((cljs.core.meta(p1__17975_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18003__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e18006){var _e__16857__auto__ = e18006;
return false;
}})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
}catch (e18011){var _e__16857__auto__ = e18011;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__18028 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__18029 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__18029);
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__18032__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__18028);
}});
...
var temp__5802__auto___18089 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___18089)){
var managed_print_level_18090 = temp__5802__auto___18089;
var _STAR_print_level_STAR__orig_val__18042_18091 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__18043_18092 = managed_print_level_18090;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__18043_18092);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__18035_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__18035_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__18042_18091);
}} else {
job_fn();
}
