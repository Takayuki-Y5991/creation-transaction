...
return [(function (){var pred__27767 = cljs.core.instance_QMARK_;
var expr__27768 = reactive_val;
if(cljs.core.truth_((pred__27767.cljs$core$IFn$_invoke$arity$2 ? pred__27767.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__27768) : pred__27767.call(null, reagent.ratom.RAtom,expr__27768)))){
return "ra";
} else {
if(cljs.core.truth_((pred__27767.cljs$core$IFn$_invoke$arity$2 ? pred__27767.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__27768) : pred__27767.call(null, reagent.ratom.RCursor,expr__27768)))){
return "rc";
} else {
if(cljs.core.truth_((pred__27767.cljs$core$IFn$_invoke$arity$2 ? pred__27767.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__27768) : pred__27767.call(null, reagent.ratom.Reaction,expr__27768)))){
return "rx";
} else {
if(cljs.core.truth_((pred__27767.cljs$core$IFn$_invoke$arity$2 ? pred__27767.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__27768) : pred__27767.call(null, reagent.ratom.Track,expr__27768)))){
return "tr";
} else {
return "other";
}
