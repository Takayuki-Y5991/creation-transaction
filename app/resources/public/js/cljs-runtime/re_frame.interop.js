...
return [(function (){var pred__22859 = cljs.core.instance_QMARK_;
var expr__22860 = reactive_val;
if(cljs.core.truth_((pred__22859.cljs$core$IFn$_invoke$arity$2 ? pred__22859.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__22860) : pred__22859.call(null, reagent.ratom.RAtom,expr__22860)))){
return "ra";
} else {
if(cljs.core.truth_((pred__22859.cljs$core$IFn$_invoke$arity$2 ? pred__22859.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__22860) : pred__22859.call(null, reagent.ratom.RCursor,expr__22860)))){
return "rc";
} else {
if(cljs.core.truth_((pred__22859.cljs$core$IFn$_invoke$arity$2 ? pred__22859.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__22860) : pred__22859.call(null, reagent.ratom.Reaction,expr__22860)))){
return "rx";
} else {
if(cljs.core.truth_((pred__22859.cljs$core$IFn$_invoke$arity$2 ? pred__22859.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__22860) : pred__22859.call(null, reagent.ratom.Track,expr__22860)))){
return "tr";
} else {
return "other";
}
