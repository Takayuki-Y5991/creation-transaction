...
var fexpr__28567 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__28567.cljs$core$IFn$_invoke$arity$1 ? fexpr__28567.cljs$core$IFn$_invoke$arity$1(type) : fexpr__28567.call(null, type));
});
...
var G__28597 = spec_tools.impl.normalize_symbol(x);
var G__28598 = null;
var G__28599 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__28597,G__28598,G__28599) : spec_tools.parse.parse_form.call(null, G__28597,G__28598,G__28599));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__28600 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__28601 = x;
var G__28602 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__28600,G__28601,G__28602) : spec_tools.parse.parse_form.call(null, G__28600,G__28601,G__28602));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__28655 = cljs.spec.alpha.form(x);
var G__28656 = options;
x = G__28655;
options = G__28656;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__28608 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__28609 = null;
var G__28610 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__28608,G__28609,G__28610) : spec_tools.parse.parse_form.call(null, G__28608,G__28609,G__28610));
} else {
...
var or__5002__auto__ = new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460).cljs$core$IFn$_invoke$arity$1(parse_data);
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
var G__28612 = parse_data;
var G__28612__$1 = (((G__28612 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__28612));
var G__28612__$2 = (((G__28612__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__28612__$1));
var G__28612__$3 = (((G__28612__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__28612__$2));
var G__28612__$4 = (((G__28612__$3 == null))?null:cljs.core.seq(G__28612__$3));
if((G__28612__$4 == null)){
return null;
} else {
return cljs.core.set(G__28612__$4);
}
}
});
if((typeof spec_tools !== 'undefined') && (typeof spec_tools.parse !== 'undefined') && (typeof spec_tools.parse.parse_form !== 'undefined')){
} else {
spec_tools.parse.parse_form = (function (){var method_table__5599__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var prefer_table__5600__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var method_cache__5601__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5602__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__28614 = cljs.core.get_global_hierarchy;
return (fexpr__28614.cljs$core$IFn$_invoke$arity$0 ? fexpr__28614.cljs$core$IFn$_invoke$arity$0() : fexpr__28614.call(null, ));
})());
...
return dispatch;
}),new cljs.core.Keyword("spec-tools.parse","default","spec-tools.parse/default",-1184283850),hierarchy__5603__auto__,method_table__5599__auto__,prefer_table__5600__auto__,method_cache__5601__auto__,cached_hierarchy__5602__auto__));
})();
}
...
var map__28621 = spec_tools.impl.parse_keys(form);
...
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28621__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__28622 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__28622__$1 = (cljs.core.truth_((function (){var or__5002__auto__ = req;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28622,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__28622);
if(cljs.core.truth_((function (){var or__5002__auto__ = opt;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
return opt_un;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28622__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__28622__$1;
}
}));
...
var vec__28623 = multi_spec_form;
var seq__28624 = cljs.core.seq(vec__28623);
var first__28625 = cljs.core.first(seq__28624);
var seq__28624__$1 = cljs.core.next(seq__28624);
var _ = first__28625;
var first__28625__$1 = cljs.core.first(seq__28624__$1);
var seq__28624__$2 = cljs.core.next(seq__28624__$1);
var multi_method_symbol = first__28625__$1;
var ___$1 = seq__28624__$2;
var form = vec__28623;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__28626){
var vec__28627 = p__28626;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28627,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28627,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__28630_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__28630_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__28631_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__28631_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__28632_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__28632_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28633_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__28633_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__28634 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__28634__$1 = cljs.core.__destructure_map(map__28634);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28634__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__28635 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__28635__$1 = cljs.core.__destructure_map(map__28635);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28635__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__28636,options){
var vec__28637 = p__28636;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28637,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28637,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28637,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__28645,options){
...
var ___$1 = first__28649;
var values = seq__28648__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__28644_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__28644_SHARP_,options);
}),values);
...
var type_priority = (function (p1__28650_SHARP_){
var G__28653 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__28652 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__28650_SHARP_);
return (fexpr__28652.cljs$core$IFn$_invoke$arity$1 ? fexpr__28652.cljs$core$IFn$_invoke$arity$1(G__28653) : fexpr__28652.call(null, G__28653));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__28651_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__28651_SHARP_,options);
}),cljs.core.rest(form))));
}));
