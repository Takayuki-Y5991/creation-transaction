...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17723 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_17723(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_17724 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_17724(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_17733 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_17733(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_17735 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_17735(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17746 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_17746(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17753 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_17753(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__17706,callback){
var map__17710 = p__17706;
var map__17710__$1 = cljs.core.__destructure_map(map__17710);
var input = map__17710__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__17710__$1,new cljs.core.Keyword(null,"code","code",1586293142));
