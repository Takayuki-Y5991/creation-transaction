...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_22765 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_22765(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_22777 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_22777(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_22804 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_22804(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_22815 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_22815(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_22841 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_22841(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_22854 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_22854(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__22718,callback){
var map__22720 = p__22718;
var map__22720__$1 = cljs.core.__destructure_map(map__22720);
var input = map__22720__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22720__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22720__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
