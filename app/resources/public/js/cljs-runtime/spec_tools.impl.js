...
var vec__28411 = cljs.core.rest(expr);
...
var vec__28414 = first__28413;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28414,(0),null);
var form = seq__28412__$1;
...
var G__28417 = x;
var G__28417__$1 = (((G__28417 == null))?null:spec_tools.impl.polish(G__28417));
var G__28417__$2 = (((G__28417__$1 == null))?null:cljs.core.name(G__28417__$1));
if((G__28417__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__28417__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__28418 = x;
var G__28418__$1 = (((G__28418 == null))?null:cljs.core.name(G__28418));
if((G__28418__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__28418__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__28420){
var map__28421 = p__28420;
var map__28421__$1 = cljs.core.__destructure_map(map__28421);
var data = map__28421__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28421__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28421__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28421__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28421__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__28426){
var map__28427 = p__28426;
var map__28427__$1 = cljs.core.__destructure_map(map__28427);
var data = map__28427__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28427__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28427__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__28428 = data;
var G__28428__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__28428,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__28428);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__28428__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__28428__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__28432 = form;
var G__28432__$1 = (((G__28432 == null))?null:cljs.core.rest(G__28432));
if((G__28432__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__28432__$1);
}
})();
var G__28433 = m;
var G__28433__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__28433,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__28429_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__28429_SHARP_)));
})):G__28433);
var G__28433__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__28433__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__28430_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__28430_SHARP_)));
})):G__28433__$1);
var G__28433__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__28433__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__28431_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__28431_SHARP_));
})):G__28433__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__28433__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__28435 = (function (){var G__28436 = form;
var G__28436__$1 = (((G__28436 == null))?null:cljs.core.rest(G__28436));
if((G__28436__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__28436__$1);
}
})();
var map__28435__$1 = cljs.core.__destructure_map(map__28435);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28435__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28435__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28435__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28435__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__28455 = (function (){var and__5000__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__28456 = form;
var G__28456__$1 = (((G__28456 == null))?null:cljs.core.seq(G__28456));
var G__28456__$2 = (((G__28456__$1 == null))?null:cljs.core.first(G__28456__$1));
if((G__28456__$2 == null)){
return null;
} else {
var fexpr__28457 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__28457.cljs$core$IFn$_invoke$arity$1 ? fexpr__28457.cljs$core$IFn$_invoke$arity$1(G__28456__$2) : fexpr__28457.call(null, G__28456__$2));
}
})():null));
});
/**
...
var len__5726__auto___28564 = arguments.length;
var i__5727__auto___28565 = (0);
while(true){
if((i__5727__auto___28565 < len__5726__auto___28564)){
args__5732__auto__.push((arguments[i__5727__auto___28565]));

var G__28566 = (i__5727__auto___28565 + (1));
i__5727__auto___28565 = G__28566;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq28471){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28471));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__28497){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__28503){
var map__28504 = p__28503;
var map__28504__$1 = cljs.core.__destructure_map(map__28504);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28504__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28504__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28504__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28504__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__28501_SHARP_){
return cljs.core.map_QMARK_(p1__28501_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__28502_SHARP_){
return cljs.core.contains_QMARK_(p1__28502_SHARP_,x);
});
}),req_keys));
