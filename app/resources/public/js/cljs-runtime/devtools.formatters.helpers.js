...
var G__17940 = devtools.prefs.pref(v);
v = G__17940;
continue;
} else {
return v;
...
}catch (e17875){var _e__16857__auto__ = e17875;
return false;
}})();
...
}catch (e17877){var _e__16857__auto__ = e17877;
return false;
}})();
...
}catch (e17882){var _e__16857__auto__ = e17882;
return false;
}}
}
});
...
var vec__17902 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17902,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17902,(1),null);
...
return cljs.core.some((function (p1__17909_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__17909_SHARP_);
}),template);
});
