...
var G__13031 = devtools.prefs.pref(v);
v = G__13031;
continue;
} else {
return v;
...
}catch (e12985){var _e__12006__auto__ = e12985;
return false;
}})();
...
}catch (e12988){var _e__12006__auto__ = e12988;
return false;
}})();
...
}catch (e12992){var _e__12006__auto__ = e12992;
return false;
}}
}
});
...
var vec__13008 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13008,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13008,(1),null);
...
return cljs.core.some((function (p1__13016_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13016_SHARP_);
}),template);
});
