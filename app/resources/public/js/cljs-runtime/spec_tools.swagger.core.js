...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null, new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__29923){
var map__29924 = p__29923;
var map__29924__$1 = cljs.core.__destructure_map(map__29924);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29924__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29924__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__29941 = spec_tools.impl.extract_form(spec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29941,(0),null);
var data = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29941,(1),null);
...
var method_cache__5601__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5602__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__29955 = cljs.core.get_global_hierarchy;
return (fexpr__29955.cljs$core$IFn$_invoke$arity$0 ? fexpr__29955.cljs$core$IFn$_invoke$arity$0() : fexpr__29955.call(null, ));
})());
...
var map__29958 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__29958__$1 = cljs.core.__destructure_map(map__29958);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29958__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29958__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__29959){
var vec__29960 = p__29959;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29960,(0),null);
var map__29963 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29960,(1),null);
var map__29963__$1 = cljs.core.__destructure_map(map__29963);
var schema = map__29963__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29963__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__5601__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__5602__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__5603__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__29972 = cljs.core.get_global_hierarchy;
...
})(),(function (){var iter__5480__auto__ = (function spec_tools$swagger$core$iter__29974(s__29975){
return (new cljs.core.LazySeq(null,(function (){
var s__29975__$1 = s__29975;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__29975__$1);
if(temp__5804__auto__){
var s__29975__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__29975__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__29975__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__29977 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__29976 = (0);
while(true){
if((i__29976 < size__5479__auto__)){
var vec__29978 = cljs.core._nth(c__5478__auto__,i__29976);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29978,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29978,(1),null);
cljs.core.chunk_append(b__29977,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__29977),spec_tools$swagger$core$iter__29974(cljs.core.chunk_rest(s__29975__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__29977),null);
}
} else {
var vec__29981 = cljs.core.first(s__29975__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29981,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29981,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__29974(cljs.core.rest(s__29975__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__29985){
var vec__29986 = p__29985;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29986,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29986,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__29989,p){
var vec__29990 = p__29989;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29990,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29990,(1),null);
var acc__$1 = vec__29990;
