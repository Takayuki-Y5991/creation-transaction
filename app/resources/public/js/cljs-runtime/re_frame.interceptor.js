...
var len__5726__auto___28652 = arguments.length;
var i__5727__auto___28653 = (0);
while(true){
if((i__5727__auto___28653 < len__5726__auto___28652)){
args__5732__auto__.push((arguments[i__5727__auto___28653]));

var G__28654 = (i__5727__auto___28653 + (1));
i__5727__auto___28653 = G__28654;
continue;
} else {
}
break;
...
(re_frame.interceptor.__GT_interceptor.cljs$core$IFn$_invoke$arity$variadic = (function (p__28502){
var map__28503 = p__28502;
var map__28503__$1 = cljs.core.__destructure_map(map__28503);
var m = map__28503__$1;
var id = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28503__$1,new cljs.core.Keyword(null,"id","id",-1388402092));
var comment = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28503__$1,new cljs.core.Keyword(null,"comment","comment",532206069));
var before = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28503__$1,new cljs.core.Keyword(null,"before","before",-1633692388));
var after = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28503__$1,new cljs.core.Keyword(null,"after","after",594996914));
if(re_frame.interop.debug_enabled_QMARK_){
var temp__5802__auto___28655 = cljs.core.seq(clojure.set.difference.cljs$core$IFn$_invoke$arity$variadic(cljs.core.set(cljs.core.keys(m)),re_frame.interceptor.mandatory_interceptor_keys,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([re_frame.interceptor.optional_interceptor_keys], 0)));
if(temp__5802__auto___28655){
var unknown_keys_28656 = temp__5802__auto___28655;
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"error","error",-978969032),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2(["re-frame: ->interceptor",m,"has unknown keys:",unknown_keys_28656], 0));
} else {
}
} else {
}

var G__28514 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"id","id",-1388402092),(function (){var or__5002__auto__ = id;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28514,new cljs.core.Keyword(null,"comment","comment",532206069),comment);
} else {
return G__28514;
}
}));
...
/** @this {Function} */
(re_frame.interceptor.__GT_interceptor.cljs$lang$applyTo = (function (seq28494){
var self__5712__auto__ = this;
return self__5712__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq28494));
}));
...
var args__5732__auto__ = [];
var len__5726__auto___28658 = arguments.length;
var i__5727__auto___28660 = (0);
while(true){
if((i__5727__auto___28660 < len__5726__auto___28658)){
args__5732__auto__.push((arguments[i__5727__auto___28660]));

var G__28661 = (i__5727__auto___28660 + (1));
i__5727__auto___28660 = G__28661;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.update_effect.cljs$lang$applyTo = (function (seq28531){
var G__28532 = cljs.core.first(seq28531);
var seq28531__$1 = cljs.core.next(seq28531);
var G__28533 = cljs.core.first(seq28531__$1);
var seq28531__$2 = cljs.core.next(seq28531__$1);
var G__28534 = cljs.core.first(seq28531__$2);
var seq28531__$3 = cljs.core.next(seq28531__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28532,G__28533,G__28534,seq28531__$3);
}));
...
/** @this {Function} */
(re_frame.interceptor.update_coeffect.cljs$lang$applyTo = (function (seq28559){
...
var G__28562 = cljs.core.first(seq28559__$2);
var seq28559__$3 = cljs.core.next(seq28559__$2);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28560,G__28561,G__28562,seq28559__$3);
}));
...
re_frame.interceptor.invoke_interceptor_fn = (function re_frame$interceptor$invoke_interceptor_fn(p__28585,interceptor,direction){
var map__28587 = p__28585;
var map__28587__$1 = cljs.core.__destructure_map(map__28587);
var context = map__28587__$1;
var original_exception_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28587__$1,new cljs.core.Keyword("re-frame.interceptor","original-exception?","re-frame.interceptor/original-exception?",-527923945));
...
var args__5732__auto__ = [];
var len__5726__auto___28695 = arguments.length;
var i__5727__auto___28696 = (0);
while(true){
if((i__5727__auto___28696 < len__5726__auto___28695)){
args__5732__auto__.push((arguments[i__5727__auto___28696]));

var G__28700 = (i__5727__auto___28696 + (1));
i__5727__auto___28696 = G__28700;
continue;
} else {
}
break;
...
/** @this {Function} */
(re_frame.interceptor.merge_ex_data.cljs$lang$applyTo = (function (seq28616){
var G__28617 = cljs.core.first(seq28616);
var seq28616__$1 = cljs.core.next(seq28616);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28617,seq28616__$1);
}));
...
var map__28625 = cljs.core.ex_data(re_frame_error);
var map__28625__$1 = cljs.core.__destructure_map(map__28625);
var event_v = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28625__$1,new cljs.core.Keyword(null,"event-v","event-v",1378681365));
var direction = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28625__$1,new cljs.core.Keyword(null,"direction","direction",-633359395));
var interceptor = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28625__$1,new cljs.core.Keyword(null,"interceptor","interceptor",1127739076));
var event_handler_QMARK_ = (function (){var fexpr__28630 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"fx-handler","fx-handler",-549783097),null,new cljs.core.Keyword(null,"db-handler","db-handler",579530098),null,new cljs.core.Keyword(null,"ctx-handler","ctx-handler",-1777672230),null], null), null);
return (fexpr__28630.cljs$core$IFn$_invoke$arity$1 ? fexpr__28630.cljs$core$IFn$_invoke$arity$1(interceptor) : fexpr__28630.call(null, interceptor));
})();
...
}catch (e28635){var e = e28635;
var G__28636 = cljs.core.ex_cause(e);
var G__28637 = re_frame.interceptor.merge_ex_data.cljs$core$IFn$_invoke$arity$variadic(e,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"event-v","event-v",1378681365),event_v], null)], 0));
return (error_handler.cljs$core$IFn$_invoke$arity$2 ? error_handler.cljs$core$IFn$_invoke$arity$2(G__28636,G__28637) : error_handler.call(null, G__28636,G__28637));
}}
});
