...
if((x instanceof cljs.core.Keyword)){
var G__28657 = spec;
var G__28658 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__28657,G__28658) : f.call(null, G__28657,G__28658));
} else {
if(typeof x === 'string'){
...
if((x instanceof cljs.core.Keyword)){
var G__28659 = spec;
var G__28660 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__28659,G__28660) : f.call(null, G__28659,G__28660));
} else {
return x;
...
if(typeof x === 'number'){
var G__28661 = spec;
var G__28662 = spec_tools.transform.number__GT_string(spec,x);
...
}catch (e28676){if((e28676 instanceof Error)){
var ___$1 = e28676;
return x;
} else {
throw e28676;
...
}catch (e28677){if((e28677 instanceof Error)){
var ___$1 = e28677;
return x;
} else {
throw e28677;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__28680,x){
var map__28681 = p__28680;
var map__28681__$1 = cljs.core.__destructure_map(map__28681);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28681__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__28682,x){
var map__28683 = p__28682;
var map__28683__$1 = cljs.core.__destructure_map(map__28683);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28683__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__28684,x){
var map__28685 = p__28684;
var map__28685__$1 = cljs.core.__destructure_map(map__28685);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28685__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
