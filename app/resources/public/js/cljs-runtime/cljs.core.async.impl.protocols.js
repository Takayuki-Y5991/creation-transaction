...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_13453 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_13453(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_13458 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_13458(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_13473 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_13473(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_13475 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_13475(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_13480 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_13480(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_13486 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_13486(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_13492 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_13492(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_13499 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_13499(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_13500 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_13500(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_13506 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_13506(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_13513 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_13513(b);
}
});
