...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_18452 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_18452(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_18457 = (function (port,val,fn1_handler){
var x__5350__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_18457(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_18462 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_18462(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_18478 = (function (chan){
var x__5350__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_18478(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_18497 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_18497(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_18501 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_18501(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_18503 = (function (h){
var x__5350__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_18503(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_18508 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_18508(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_18512 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_18512(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_18513 = (function (b,itm){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_18513(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_18514 = (function (b){
var x__5350__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_18514(b);
}
});
