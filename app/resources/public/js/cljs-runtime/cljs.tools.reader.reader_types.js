...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_24788 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_24788(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_24789 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_24789(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24790 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_24790(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24791 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_24791(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24792 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_24792(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24793 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_24793(reader);
}
});
...
var G__24838 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__24839 = s.append(c);
c = G__24838;
s = G__24839;
continue;
}
