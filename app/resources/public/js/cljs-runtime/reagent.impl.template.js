...
var G__27264 = o;
reagent.impl.template.goog$module$goog$object.set(G__27264,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__27437__i < G__27437__a.length) {G__27437__a[G__27437__i] = arguments[G__27437__i + 0]; ++G__27437__i;}
  args = new cljs.core.IndexedSeq(G__27437__a,0,null);
} 
...
var G__27273 = o;
reagent.impl.template.goog$module$goog$object.set(G__27273,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__27440__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__27440 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__27441__i = 0, G__27441__a = new Array(arguments.length -  0);
while (G__27441__i < G__27441__a.length) {G__27441__a[G__27441__i] = arguments[G__27441__i + 0]; ++G__27441__i;}
  args = new cljs.core.IndexedSeq(G__27441__a,0,null);
} 
return G__27440__delegate.call(this,args);};
G__27440.cljs$lang$maxFixedArity = 0;
G__27440.cljs$lang$applyTo = (function (arglist__27442){
var args = cljs.core.seq(arglist__27442);
return G__27440__delegate(args);
});
...
var G__27276 = props;
var G__27276__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27276,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__27276);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27276__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__27287 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__27287,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__27287;
}
})(),id_class);
...
var G__27301 = (cljs.core.count(argv) - first_child);
switch (G__27301) {
case (0):
...
var vec__27307 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27307,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27307,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27307,(2),null);
...
var temp__5808__auto___27452 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___27452 == null)){
} else {
var key_27454 = temp__5808__auto___27452;
(jsprops.key = key_27454);
}
...
var temp__5808__auto___27459 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___27459 == null)){
} else {
var key_27460 = temp__5808__auto___27459;
(jsprops.key = key_27460);
}
...
var temp__5808__auto___27467 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___27467 == null)){
} else {
var key_27468 = temp__5808__auto___27467;
(jsprops.key = key_27468);
}
...
var temp__5808__auto___27473 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___27473 == null)){
} else {
var key_27474 = temp__5808__auto___27473;
(jsprops.key = key_27474);
}
...
var temp__5808__auto___27475 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___27475 == null)){
} else {
var key_27479 = temp__5808__auto___27475;
(jsprops.key = key_27479);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27348_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__27348_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__27356 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27356,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27356,(1),null);
...
break;
default:
var G__27492 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__27493 = compiler;
v = G__27492;
compiler = G__27493;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template27407 = (function (opts,id,fn_to_element,parse_fn,meta27408){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template27407.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_27409,meta27408__$1){
var self__ = this;
var _27409__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template27407(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta27408__$1));
}));

(reagent.impl.template.t_reagent$impl$template27407.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_27409){
var self__ = this;
var _27409__$1 = this;
return self__.meta27408;
}));

(reagent.impl.template.t_reagent$impl$template27407.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template27407.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template27407.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template27407.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template27407.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template27407.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta27408","meta27408",151841716,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template27407.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template27407.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template27407");

(reagent.impl.template.t_reagent$impl$template27407.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template27407");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template27407.
 */
reagent.impl.template.__GT_t_reagent$impl$template27407 = (function reagent$impl$template$__GT_t_reagent$impl$template27407(opts,id,fn_to_element,parse_fn,meta27408){
return (new reagent.impl.template.t_reagent$impl$template27407(opts,id,fn_to_element,parse_fn,meta27408));
});
...
return (new reagent.impl.template.t_reagent$impl$template27407(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
