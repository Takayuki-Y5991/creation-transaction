...
var G__22321 = o;
reagent.impl.template.goog$module$goog$object.set(G__22321,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__22327 = o;
reagent.impl.template.goog$module$goog$object.set(G__22327,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__22520__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__22520__delegate.call(this,args);};
G__22520.cljs$lang$maxFixedArity = 0;
G__22520.cljs$lang$applyTo = (function (arglist__22524){
var args = cljs.core.seq(arglist__22524);
return G__22520__delegate(args);
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22340 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22340,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22340;
}
})(),id_class);
...
var G__22345 = (cljs.core.count(argv) - first_child);
switch (G__22345) {
case (0):
...
var vec__22351 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22351,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22351,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22351,(2),null);
...
var temp__5808__auto___22542 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22542 == null)){
} else {
var key_22543 = temp__5808__auto___22542;
(jsprops.key = key_22543);
}
...
var temp__5808__auto___22544 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22544 == null)){
} else {
var key_22545 = temp__5808__auto___22544;
...
var temp__5808__auto___22546 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22546 == null)){
} else {
var key_22548 = temp__5808__auto___22546;
(jsprops.key = key_22548);
}
...
var temp__5808__auto___22567 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22567 == null)){
} else {
var key_22568 = temp__5808__auto___22567;
(jsprops.key = key_22568);
}
...
var temp__5808__auto___22573 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22573 == null)){
} else {
var key_22574 = temp__5808__auto___22573;
(jsprops.key = key_22574);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22405_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22405_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22427 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22427,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22427,(1),null);
...
break;
default:
var G__22589 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
...
*/
reagent.impl.template.t_reagent$impl$template22498 = (function (opts,id,fn_to_element,parse_fn,meta22499){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template22498.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22500,meta22499__$1){
var self__ = this;
var _22500__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22498(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22499__$1));
}));

(reagent.impl.template.t_reagent$impl$template22498.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22500){
var self__ = this;
var _22500__$1 = this;
return self__.meta22499;
}));

(reagent.impl.template.t_reagent$impl$template22498.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22498.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22498.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22498.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22498.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22498.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22499","meta22499",-1772999028,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22498.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22498.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22498");

(reagent.impl.template.t_reagent$impl$template22498.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22498");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22498.
 */
reagent.impl.template.__GT_t_reagent$impl$template22498 = (function reagent$impl$template$__GT_t_reagent$impl$template22498(opts,id,fn_to_element,parse_fn,meta22499){
return (new reagent.impl.template.t_reagent$impl$template22498(opts,id,fn_to_element,parse_fn,meta22499));
});
...
return (new reagent.impl.template.t_reagent$impl$template22498(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
